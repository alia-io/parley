...
class QuestionResourceIT {
    ...
    public static Question createEntity(EntityManager em) {
        Question question = new Question().questionName(DEFAULT_QUESTION_NAME).question(DEFAULT_QUESTION);
        return question;
    }
    ...
    public static Question createUpdatedEntity(EntityManager em) {
        Question question = new Question().questionName(UPDATED_QUESTION_NAME).question(UPDATED_QUESTION);
        return question;
    }
    ...
    void putNewQuestion() throws Exception {
        ...
        updatedQuestion.questionName(UPDATED_QUESTION_NAME).question(UPDATED_QUESTION);
    ...
    void partialUpdateQuestionWithPatch() throws Exception {
        ...
        partialUpdatedQuestion.questionName(UPDATED_QUESTION_NAME).question(UPDATED_QUESTION);
